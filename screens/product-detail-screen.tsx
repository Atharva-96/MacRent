        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.ownerContainer}>
              <Ionicons name="person-circle-outline" size={40} color="#1E88E5" />
              <View style={styles.ownerInfo}>
                <Text style={styles.ownerName}>{machine.owner || "Unknown Owner"}</Text>
                {/* Use the same contact details that are shown in the modal */}
                <Text style={styles.ownerContact}>{machine.ownerPhone || "Phone not available"}</Text>
                <Text style={styles.ownerContact}>{machine.ownerEmail || "Email not available"}</Text>
              </View>
            </View>
          </View>
